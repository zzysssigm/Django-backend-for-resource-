# Generated by Django 5.0.6 on 2024-08-02 07:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('block_end_time', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='user',
            name='blocklist',
            field=models.ManyToManyField(related_name='blocked_by', through='myapp.BlockList', to=settings.AUTH_USER_MODEL),
        ),
    ]
